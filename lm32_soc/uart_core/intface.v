...
*/
    parameter A_RBR = 6'b000000;
    parameter A_THR = 6'b000000;
    parameter A_IER = 6'b000100;
    parameter A_IIR = 6'b001000;
    parameter A_LCR = 6'b001100;
    parameter A_LSR = 6'b010100;
    parameter A_DIV = 3'b100;
...
//   assign div_wr_strobe = (adr_i[UART_WB_ADR_WIDTH-1:1] == A_DIV) &&  cyc_i && stb_i &&  we_i;  
   assign div_wr_strobe = (adr_i[UART_WB_ADR_WIDTH-1:3] == A_DIV) &&  cyc_i && stb_i &&  we_i;  
