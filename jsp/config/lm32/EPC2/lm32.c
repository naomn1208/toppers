...
//    sil_wrw_mem((VP)UART1_DIV, divisor);
    ...
    divisor = ( MICO32_CPU_CLOCK_HZ / DEFAULT_UART_BAUDRATE );
    sil_wrw_mem((VP)UART1_DIV1, divisor);
    sil_wrw_mem((VP)UART1_DIV2, ((divisor >> 8) & 0xff) );
...
//    sil_wrw_mem((VP)siopinib->div, divisor);
    ...
    divisor = ( MICO32_CPU_CLOCK_HZ / DEFAULT_UART_BAUDRATE );
    sil_wrw_mem((VP)siopinib->div1, (divisor & 0xff) );
    sil_wrw_mem((VP)siopinib->div2, ((divisor >> 8) & 0xff) );
